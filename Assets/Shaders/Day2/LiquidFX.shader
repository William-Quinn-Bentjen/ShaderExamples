	...
	Properties
	{
		...
		SubShader
		{
			...
			v2f vert (appdata v)
			{
				...
				//combine with world pos based on sin wave
				float3 worldAdjusted = worldPos + (worldPosX * _WobbleX) + (worldPosZ * _WobbleZ);
				//fill Line
				o.fillEdge = worldAdjusted.y + _FillAmount;
